	...
	<body>
		...
		<div class="admin">
			<div class="admin-header">
				<p style="padding-left:40%; text-decoration:underline;">ALL Pending loans</p>
				<div>
				</div>
			</div>
		</div>
					...
					$output .="
						<tbody>
							<tr>
								...
								<td>
									<a href='grant_loan.php?id=".$row['id']."'><button style='background:#0298cf; color:#fff;'>View</button></a>
								</td>
								";
			}
			$output .="
